...
namespace Schoolmanagementsystem
{
    public partial class Teacher : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand cnn = new MySqlCommand("insert into teachertab values(@TeacherId,@TeacherName,@Gender,@Phone)", con);
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand cnn = new MySqlCommand("select * from teachertab", con);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand cnn = new MySqlCommand("update teachertab set TeacherName = @TeacherName,Gender = @Gender,Phone = @Phone where TeacherId = @TeacherId", con);
            cnn.Parameters.AddWithValue("@TeacherId", int.Parse(textBox1.Text));
            cnn.Parameters.AddWithValue("@TeacherName", textBox2.Text);
            cnn.Parameters.AddWithValue("@Gender", comboBox1.Text);
            cnn.Parameters.AddWithValue("@Phone", textBox3.Text);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    con.Open();
                    string query = "DELETE FROM teachertab WHERE TeacherId = @TeacherId";
                    using (MySqlCommand cnn = new MySqlCommand(query, con))
                    {
                        ...
                        {
                            MessageBox.Show("No record found with the specified TeacherId", "Deleted", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        }
                    }
                }
            }
            ...
            {
                MessageBox.Show("Invalid TeacherId. Please enter a valid numeric value.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
